...
Additionally, note that in @tbl-horses we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horse_pops_plot_largest width=60%}

In @fig-horse_pops_plot_largest we zoom in and look at the province of `{r} largest_sd` which had the largest spread of values in terms of standard deviation.
